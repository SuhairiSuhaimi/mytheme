...
INTRODUCTION
------------
 kym is a Drupal 8 theme. Its simple, lightweight and very easy to use. Best suited for business, service providers, freelancer website.
...
REQUIREMENTS
------------
kym theme does not require anything beyond Drupal 8 core to work.

INSTALLATION
------------
1. Place "kym" folder to the root /themes directory.
2. Login to the site and click on "Appearance" in the top Administration menu.
3. Click on "Install and set as default" next to kym theme.
...
CONFIGURATION
-------------
Navigate to: Administration >> Appearance >> Settings >> kym
